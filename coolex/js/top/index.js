...
},{"@splidejs/splide":"../node_modules/@splidejs/splide/dist/js/splide.esm.js"}],"js/top/components/video.ts":[function(require,module,exports) {
"use strict";
...
var videoPlayer = function videoPlayer() {
  ...
  var parent = document.querySelector(".js-video");
  if (parent) {
    var videos = parent.querySelectorAll(".js-video-item");
    videos.forEach(function (video) {
      var videoOverlay = video.nextElementSibling;
      var close = videoOverlay.querySelector(".js-video-close");
      var vidFrame = videoOverlay.querySelector('.js-video-frame');
      var originalSrc = vidFrame.getAttribute('src');
...
},{"./components/slider":"js/top/components/slider.ts","./components/video":"js/top/components/video.ts"}]},{},["js/top/index.ts"], null)
